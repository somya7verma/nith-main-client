...
const sampleOrdinances: OrdinanceItem[] = [
  {
    ...
    documentUrl: '/documents/ordinances/masters-ordinances-2025.pdf',
    fileType: 'pdf',
  },
  {
    id: 2,
    ...
    documentUrl: '/documents/ordinances/masters-ordinances-2021.pdf',
    fileType: 'pdf',
  },
  {
    id: 3,
    ...
    documentUrl: '/documents/ordinances/masters-ordinances-2018.pdf',
    fileType: 'pdf',
  },
];
...
export default function MasterOrdinances() {
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
                Academic rules and regulations governing postgraduate programmes
                at the Institute.
              </p>
            </motion.div>
          </div>
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                >
                  <h2 className="text-lg font-semibold text-gray-900 mb-3">
                    About Master Ordinances
                  </h2>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Master Ordinances define the rules, regulations, and
                    academic framework governing postgraduate programmes at NIT
                    Hamirpur. These ordinances outline policies related to
                    admission, registration, curriculum structure, assessment,
                    evaluation, progression, and award of postgraduate degrees.
                    They are approved by the Institute&apos;s statutory academic
                    bodies and apply to M.Tech., M.Arch., M.Sc., MBA and other
                    postgraduate programmes as specified.
                  </p>
                </motion.div>
