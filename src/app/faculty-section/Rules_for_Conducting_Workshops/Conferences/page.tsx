...
const initialNewsData: NewsItem[] = [
  {
    id: 1,
    title: 'NITH Rules for conduction workshop Association Announces Annual Meet 2025',
    description: 'The NIT Hamirpur Rules for conduction workshop Association is pleased to announce the Annual Rules for conduction workshop Meet scheduled for March 2025. All registered Rules for conduction workshop are cordially invited to participate in this grand event celebrating our shared legacy.',
    image: '/news/Rules for conduction workshop-meet.jpg',
    date: '2025-01-15',
  ...
  {
    id: 2,
    title: 'Distinguished Rules for conduction workshop Award Nominations Open',
    description: 'Nominations are now open for the Distinguished Rules for conduction workshop Award 2025. The award recognizes outstanding contributions by NITH Rules for conduction workshop in their respective fields. Submit your nominations before the deadline.',
    image: '/news/award.jpg',
    date: '2025-01-12',
    slug: 'distinguished-Rules for conduction workshop-award-2025',
    downloadUrl: '/downloads/distinguished-Rules for conduction workshop-award-2025.pdf',
  },
];
...
export default function WorkshopRules() {
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-gray-50 py-4 px-6 md:px-12 border-b border-gray-200">
          <div className="max-w-7xl mx-auto">
            <nav className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>›</span>
              <span className="text-[#800000] font-medium">Rules for conduction Workshop/Conferences</span>
            </nav>
          </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-[#631012] via-[#7a1a1d] to-[#4a0c0e] py-16 md:py-24">
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Rules for conduction Workshop/Conferences</h1>
              <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
                Latest news, announcements, and updates from the NITH Rules for conduction workshop community.
              </p>
            </motion.div>
          </div>
        </section>
                          ...
                          <div className="flex-1 p-5 sm:p-6 flex flex-col">
                            <div className="flex-1">
                              <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-[#631012] transition-colors line-clamp-2">
                                <Link href={`/workshop-rules/news/${item.slug}`}>{item.title}</Link>
                              </h3>
                            ...
                            <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <Link
                                  href={`/workshop-rules/news/${item.slug}`}
