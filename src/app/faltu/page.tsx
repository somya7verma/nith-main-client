...
function Page() {
  ...
  return (
    <>
      <div className="bg-black p-1 max-w-screen h-60 relative overflow-visible">
        <div className="bg-white h-60 gridan overflow-visible">
          <div
            id="st"
          ...
          <div id="navbar" className="relative overflow-visible z-40">
            ...
            {activeDropdown && (
              <div
                className="absolute top-full -left-60 w-[95vw] h-[50vh] bg-white text-black shadow-2xl z-[9999] overflow-auto"
