...
const initialNewsData: NewsItem[] = [
  {
    id: 1,
    title:
      'NITH Rules for conduction workshop Association Announces Annual Meet 2025',
    description:
      'The NIT Hamirpur Rules for conduction workshop Association is pleased to announce the Annual Rules for conduction workshop Meet scheduled for March 2025. All registered Rules for conduction workshop are cordially invited to participate in this grand event celebrating our shared legacy.',
  ...
  },
  {
    ...
    description:
      'Nominations are now open for the Distinguished Rules for conduction workshop Award 2025. The award recognizes outstanding contributions by NITH Rules for conduction workshop in their respective fields. Submit your nominations before the deadline.',
    image: '/news/award.jpg',
    date: '2025-01-12',
    slug: 'distinguished-Rules for conduction workshop-award-2025',
    downloadUrl:
      '/downloads/distinguished-Rules for conduction workshop-award-2025.pdf',
  },
];
          ...
          <div className="max-w-7xl mx-auto">
            <nav className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span className="text-[#800000] font-medium">
                Rules for conduction Workshop/Conferences
              </span>
            </nav>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
                Latest news, announcements, and updates from the NITH Rules for
                conduction workshop community.
              </p>
            </motion.div>
          </div>
        </section>
