...
const sampleOrdinances: OrdinanceItem[] = [
  {
    ...
    documentUrl: '/documents/ordinances/doctoral-ordinances-2023.pdf',
    fileType: 'pdf',
  },
  {
    id: 2,
    ...
    documentUrl: '/documents/ordinances/doctoral-ordinances-2019.pdf',
    fileType: 'pdf',
  },
  {
    id: 3,
    ...
    documentUrl: '/documents/ordinances/doctoral-ordinances-2016.pdf',
    fileType: 'pdf',
  },
];
...
export default function DoctoralOrdinances() {
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
                Academic rules and regulations governing doctoral and research
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                >
                  <h2 className="text-lg font-semibold text-gray-900 mb-3">
                    About Doctoral Ordinances
                  </h2>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Doctoral Ordinances set out the regulations governing
                    doctoral (Ph.D.) and research degree programmes at NIT
                    Hamirpur. These documents detail admission criteria,
                    supervision norms, coursework requirements, minimum
                    residency, thesis submission, viva-voce, and award of
                    degree. Ordinances are approved by the Institute&apos;s
                    statutory academic bodies and are periodically revised.
                  </p>
                </motion.div>
                ...
                >
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">
                    How Doctoral Ordinances Work
                  </h3>
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 text-sm leading-relaxed">
                    <li>
                      Ordinances are applicable from a specified academic
                    ...
                    <li>
                      ...
                      policies and research best practices.
                    </li>
                    <li>
                      Students and research scholars are governed by the
                      ordinance applicable to their year of admission unless
                      otherwise specified.
                    </li>
                  </ul>
                </motion.div>
                ...
                >
                  ...
                  <div className="text-sm text-gray-600 leading-relaxed">
                    <div className="bg-[#fff7ed] border border-[#ffedd5] rounded-lg p-3 text-sm text-gray-700">
                      <p className="mb-1">
                        Research scholars must follow the ordinance applicable
                        to their admission year.
                      </p>
                      <p className="mb-1">
                    ...
                    {ordinances.map((o, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-500 mb-4 ml-11">
                          ...
                          <span>
                            Effective from: {formatYear(o.effectiveDate)}
                          </span>
                        </div>
