...
const initialDownloadsData: DownloadsItem[] = [
  {
    ...
    description:
      'The NIT Hamirpur Download for Students Association is pleased to announce the Annual Download for Students Meet scheduled for March 2025. All registered Download for Students are cordially invited to participate in this grand event celebrating our shared legacy.',
  ...
  },
  {
    ...
    description:
      'Nominations are now open for the Distinguished Download for Students Award 2025. The award recognizes outstanding contributions by NITH Download for Students in their respective fields. Submit your nominations before the deadline.',
    image: '/Downloads/award.jpg',
    date: '2025-01-12',
    slug: 'distinguished-Download-for-Students-award-2025',
    downloadUrl:
      '/downloads/distinguished-Download-for-Students-award-2025.pdf',
  },
];
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
                ...
                Download for Students community.
              </p>
            </motion.div>
          </div>
        </section>
              ...
              {loading ? (
                ...
                >
                  ...
                  <p className="text-gray-500 mb-6">
                    There are no download items available.
                  </p>
                </motion.div>
              ) : (
                          ...
                          <div className="flex-1 p-5 sm:p-6 flex flex-col">
                            <div className="flex-1">
                              <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-[#631012] transition-colors line-clamp-2">
                                <Link href={`/downloads/students/${item.slug}`}>
                                  {item.title}
                                </Link>
                              </h3>
