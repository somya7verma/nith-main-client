...
const initialDownloadsData: DownloadItem[] = [
  {
    id: 1,
    title: 'NITH Downloads for Faculty Association Announces Annual Meet 2025',
    description: 'The NIT Hamirpur Downloads for Faculty Association is pleased to announce the Annual Downloads for Faculty Meet scheduled for March 2025. All registered Downloads for Faculty are cordially invited to participate in this grand event celebrating our shared legacy.',
  ...
  {
    id: 2,
    title: 'Distinguished Downloads for Faculty Award Nominations Open',
    description: 'Nominations are now open for the Distinguished Downloads for Faculty Award 2025. The award recognizes outstanding contributions by NITH Downloads for Faculty in their respective fields. Submit your nominations before the deadline.',
    image: '/Downloads/award.jpg',
    date: '2025-01-12',
    slug: 'distinguished-Downloads-for-Faculty-award-2025',
    downloadUrl: '/downloads/distinguished-Downloads-for-Faculty-award-2025.pdf',
  },
];
...
export default function Downloads() {
  const [downloads, setDownloads] = useState<DownloadItem[]>(initialDownloadsData);
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-gray-50 py-4 px-6 md:px-12 border-b border-gray-200">
          <div className="max-w-7xl mx-auto">
            <nav className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>›</span>
              <span className="text-gray-400">Downloads for Faculty</span>
            </nav>
          </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-[#631012] via-[#7a1a1d] to-[#4a0c0e] py-16 md:py-24">
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Downloads for Faculty</h1>
        ...
        <section className="py-12 md:py-16 px-4 md:px-6">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <span className="font-semibold text-gray-700">Total Downloads for Faculty: {downloads.length}</span>
            </motion.div>
            ...
            <div className="w-full">
              ...
              {loading ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">No Downloads for Faculty available</h3>
                  <p className="text-gray-500 mb-6">There are no Downloads for Faculty items available.</p>
                </motion.div>
              ) : (
