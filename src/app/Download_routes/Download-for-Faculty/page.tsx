...
const initialDownloadsData: DownloadItem[] = [
  {
    ...
    description:
      'The NIT Hamirpur Downloads for Faculty Association is pleased to announce the Annual Downloads for Faculty Meet scheduled for March 2025. All registered Downloads for Faculty are cordially invited to participate in this grand event celebrating our shared legacy.',
  ...
  },
  {
    ...
    description:
      'Nominations are now open for the Distinguished Downloads for Faculty Award 2025. The award recognizes outstanding contributions by NITH Downloads for Faculty in their respective fields. Submit your nominations before the deadline.',
    image: '/Downloads/award.jpg',
    date: '2025-01-12',
    slug: 'distinguished-Downloads-for-Faculty-award-2025',
    downloadUrl:
      '/downloads/distinguished-Downloads-for-Faculty-award-2025.pdf',
  },
];
...
export default function Downloads() {
  const [downloads, setDownloads] =
    useState<DownloadItem[]>(initialDownloadsData);
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
                Latest Downloads for Faculty, announcements, and updates from
                the NITH Downloads for Faculty community.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <span className="font-semibold text-gray-700">
                Total Downloads for Faculty: {downloads.length}
              </span>
            </motion.div>
              ...
              {loading ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">
                    No Downloads for Faculty available
                  </h3>
                  <p className="text-gray-500 mb-6">
                    There are no Downloads for Faculty items available.
                  </p>
                </motion.div>
              ) : (
