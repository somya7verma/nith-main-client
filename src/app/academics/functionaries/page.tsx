            ...
            <table className="w-full text-left table-fixed border-collapse">
              ...
              <tbody>
                <tr className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-3">
                    <a href="mailto:dac@nith.ac.in" className="text-[#800000]">
                      dac@nith.ac.in
                    </a>
                  </td>
                </tr>
                ...
                <tr className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-3">Associate Dean (UG-PG Establishment)</td>
                  <td className="py-3">254532</td>
                  <td className="py-3">
                    <a href="mailto:nath@nith.ac.in" className="text-[#800000]">
                      nath@nith.ac.in
                    </a>
                  </td>
                </tr>
            ...
            <table className="w-full text-left table-fixed border-collapse">
              ...
              <tbody>
                <tr className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-3">
                    <a href="mailto:ukp@nith.ac.in" className="text-[#800000]">
                      ukp@nith.ac.in
                    </a>
                  </td>
                </tr>
            ...
            <table className="w-full text-left table-fixed border-collapse">
              ...
              <tbody>
                <tr className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-3">254006</td>
                  <td className="py-3">
                    <a href="mailto:nad@nith.ac.in" className="text-[#800000]">
                      nad@nith.ac.in
                    </a>
                  </td>
                </tr>
                ...
                <tr className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-3">Faculty Incharge (NAD-Verification)</td>
            ...
            <table className="w-full text-left table-auto border-collapse">
              ...
              <tbody>
                ...
                <tr className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-3">
                    Stenographer SG-II (All matters related to Results of UG/PG)
                  </td>
                  <td className="py-3">-</td>
                  <td className="py-3">
                    <a
