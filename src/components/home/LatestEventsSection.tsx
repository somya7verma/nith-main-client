    ...
    <section className="bg-background py-16">
      <div className="container mx-auto px-6">
        <div className="mb-10 flex items-center justify-between">
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-0">
            Latest Events
          </h2>
          <button className="text-sm md:text-base font-semibold text-white duration-300 px-5 py-2 rounded-lg shadow-md hover:shadow-lg cursor-pointer hover:scale-110 transition-transform">
            View All
          </button>
        </div>
